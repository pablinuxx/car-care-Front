      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div className="col-6 information-box text-white d-flex flex-column align-items-start justify-content-start g-0">
            <h1 className="fw-bold fs-1 ms-4 mt-5">{car && car.name}</h1>
            <h3 className="fs-3 ms-4 mt-1">{car && car.description}</h3>
            <h2 className="fw-bold fs-1 ms-4 mt-2">USD {car && car.price}</h2>
          </div>
        </div>
        <div className="row">
          <div className="col g-0">
